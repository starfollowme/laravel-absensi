...
<head>
  ...
  <title>Dashboard Sudah Absen</title>
  ...
  <div class="container" style="max-width:412px;margin:auto;background:#fff;min-height:100vh;box-shadow:0 0 8px #eee;">
    ...
    <div style="padding:16px;">
      ...
      <div style="display:flex;gap:16px;align-items:center;justify-content:center;margin-bottom:16px;">
        <div style="background:#e3f0ff;border-radius:16px;padding:0 0 0 12px;box-shadow:0 2px 8px #0001;display:flex;align-items:center;justify-content:center;width:90px;height:260px;margin-right:-24px;z-index:1;">
        ...
        <div style="background:#f5f7fa;border-radius:12px;padding:12px 18px;box-shadow:0 2px 8px #0001;min-width:320px;max-width:340px;position:relative;z-index:2;">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
            <img src="/img/logo-sekolah.png" alt="Logo" style="width:38px;height:38px;">
            <div>
              <div style="font-size:11px;color:#222;font-weight:600;">PEMERINTAH PROVINSI JAWA BARAT</div>
              <div style="font-size:17px;color:#222;font-weight:700;">SMK NEGERI 11 BANDUNG</div>
              <div style="font-size:10px;color:#444;">Bisnis Manajemen - Teknologi Informasi - Seni dan Ekonomi Kreatif</div>
            </div>
          </div>
          <hr style="margin:8px 0;">
          <div style="font-size:16px;font-weight:700;margin-bottom:8px;">MUHAMMAD ANDRA MAULANA</div>
          <div style="display:grid;grid-template-columns:140px 1fr;gap:2px 8px;font-size:13px;">
      ...
      <div style="width:100%;display:flex;justify-content:center;margin-bottom:16px;">
        <div style="background:#43c463;color:#fff;font-weight:600;font-size:18px;padding:10px 0;border-radius:8px;width:100%;max-width:320px;box-shadow:0 2px 8px #0002;text-align:center;">Status: Sudah Absen</div>
      </div>
      ...
      <div style="font-size:18px;font-weight:600;color:#222;margin-bottom:12px;">Menu Utama</div>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;">
        <div style="background:#e3f0ff;border-radius:12px;padding:16px 0;text-align:center;box-shadow:0 2px 8px #0001;">
          <img src="/img/absen.svg" alt="Absen" style="width:38px;height:38px;margin-bottom:6px;">
          <div style="font-size:14px;font-weight:600;color:#222;">Absen Hari ini</div>
        </div>
        <div style="background:#e3f0ff;border-radius:12px;padding:16px 0;text-align:center;box-shadow:0 2px 8px #0001;">
          <img src="/img/bukti.svg" alt="Bukti" style="width:38px;height:38px;margin-bottom:6px;">
          <div style="font-size:14px;font-weight:600;color:#222;">Bukti Izin/Sakit</div>
        </div>
        <div style="background:#e3f0ff;border-radius:12px;padding:16px 0;text-align:center;box-shadow:0 2px 8px #0001;">
          <img src="/img/rekap.svg" alt="Rekap" style="width:38px;height:38px;margin-bottom:6px;">
          <div style="font-size:14px;font-weight:600;color:#222;">Riwayat Absensi</div>
        </div>
      </div>
    </div>
